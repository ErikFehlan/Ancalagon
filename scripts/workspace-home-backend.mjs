...
const response=await fetch('https://api.supabase.com/v1/projects/'+ref+'/database/query',{
 ...
 body:JSON.stringify({query:(await Promise.all(['20260914210000_workspace_home.sql','20260915110000_guided_tutorial.sql','20260915150000_admin_tools.sql','20260916180000_contextual_guidance.sql'].map(name=>readFile('supabase/migrations/'+name,'utf8')))).join('\n')}),signal:AbortSignal.timeout(60000)});
