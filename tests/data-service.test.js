...
const calls = [];
const rows = {
  jobs: [{ id: jobId, workspace_id: workspaceId, title: 'QA Analyst', criteria: [], knockouts: [], weights: [], pattern_analysis: { summary: 'Remote result' }, created_at: '2026-09-09T00:00:00Z', updated_at: '2026-09-09T00:00:00Z' }],
