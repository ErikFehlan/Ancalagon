...
(async()=>{
 ...
 try{
  ...
  await page.locator('#authSubmit').click();await page.locator('#welcomeModal').waitFor();assert.equal(await page.locator('#createAccountTab').getAttribute('aria-selected'),'false');await page.locator('#welcomeContinue').click();
